...
namespace AvigilonAlarmDemoApp.UI.Utility
{
    //Class to send and recieve messages between view models
    public class Messenger
    {
        ...
        private static Messenger k_instance;
